...
(function () {
    ...
    // News sliders
    var newsSlidersEls = document.querySelectorAll('.news-photos-card__slider');
    if (newsSlidersEls && newsSlidersEls.length > 0) {
        newsSlidersEls.forEach(function (item) {
            var homeHeroSlideshow = Peppermint(item, {
                slideshow: false,
                dots: true
            });
        })
